...
const oneyob = document.getElementsByClassName("fp-viewing-page-developer-0");
const onVeganfind = document.getElementsByClassName("fp-viewing-page-graphic-0");
const onEcoimpakt = document.getElementsByClassName("fp-viewing-page-ux-0");
const onLupamove = document.getElementsByClassName("fp-viewing-page-wordpress-0");
const onCastlexperience = document.getElementsByClassName("fp-viewing-page-app-0");
const onDragonleaves = document.getElementsByClassName("fp-viewing-page-social-0");
...
const eyobH1 = document.getElementsByClassName("eyobh1")[0].style;
  ...
  mutationList.forEach(function (mutation) {
    if (mutation.type === 'attributes' && mutation.attributeName === 'class') {
      ...
      if (oneyob.length) {
        ...
        yellowSmall.style.backgroundColor = "var(--eyobpurple)";
        body.style.backgroundColor = 'var(--eyobpurple)';
        ...
        if (window.innerWidth <= 980) {
          links.forEach(link => link.style.color = 'var(--eyobpurple)');
        }
      }
